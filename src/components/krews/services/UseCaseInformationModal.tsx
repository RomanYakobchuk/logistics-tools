...
const useCaseInfoData: UseCaseInfo[] = [
    ...
    },
    {
        value: 'discussion',
        label: 'Discussion',
        description: 'Two-way communication channels for discussions, customer support, and interactive conversations.',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
        value: 'poll',
        label: 'Poll',
        description: 'Gather feedback, conduct surveys, and collect votes through SMS-based polling.',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        benefits: [
            ...
            'Real-time results',
            'Simplified audience participation'
        ]
    },
    {
        value: 'undeclared',
        label: 'Undeclared',
        description: 'General or custom SMS services for specialized use cases not covered by standard categories.',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
